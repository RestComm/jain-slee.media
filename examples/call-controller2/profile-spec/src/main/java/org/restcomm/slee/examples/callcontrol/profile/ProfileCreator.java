...
package org.restcomm.slee.examples.callcontrol.profile;
...
public class ProfileCreator {
	...
	public static final String CC2_ProfileSpecID = "ProfileSpecificationID[name=CallControlProfileCMP,vendor=org.restcomm,version=0.1]";
	...
	private static void _createProfiles() {
		...
		try {
			...
			String controllerProfileSpecID = "ProfileSpecificationID[name=CallControlProfileCMP,vendor=org.restcomm,version=0.1]";
			...
			newProfile(adaptor,sci,profileTableName, "restcomm", "sip:restcomm@"+domain, null, null, false,user,password);
			log.info("********** CREATED PROFILE: restcomm **********");

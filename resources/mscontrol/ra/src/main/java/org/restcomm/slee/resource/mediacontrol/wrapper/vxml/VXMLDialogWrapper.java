 ...
 * MA 02110-1301, USA.
 */
package org.restcomm.slee.resource.mediacontrol.wrapper.vxml;
...
import org.restcomm.slee.resource.mediacontrol.wrapper.MediaSessionWrapper;
import org.restcomm.slee.resource.mediacontrol.wrapper.join.JoinableContainerWrapper;
...
public class VXMLDialogWrapper extends JoinableContainerWrapper implements VxmlDialog, MsActivity {
	...
	/* (non-Javadoc)
	 * @see JoinableContainerWrapper#getEventHandle()
	 */
